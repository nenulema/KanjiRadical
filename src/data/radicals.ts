...
export const RADICALS_DATA: RadicalInfo[] = [
  ...
  },
  {
    ...
    symbol: "人",
    variants: ["亻", "𠆢"],
    kanjiList: ["人", "休", "何", "会", "今", "作", "体", "係", "仕", "使", "住", "他", "代", "倍", "以", "位", "億", "健", "候", "借", "信", "倉", "側", "仲", "低", "停", "伝", "働", "付", "便", "令", "例", "仮", "価", "件", "個", "似", "修", "像", "任", "備", "俵", "仏", "保", "余", "供", "傷", "仁", "値", "俳", "優", "依", "偉", "介", "儀", "仰", "傾", "伺", "侵", "僧", "俗", "倒", "傍", "佳", "企", "偶", "倹", "債", "催", "侍", "伸", "促", "伐", "伴", "伏", "倣", "偽", "傑", "候", "佐", "傘", "儒", "俊", "償", "仙", "但", "偵", "伯", "侮", "併", "偏", "俸", "僕", "僚", "倫", "俺", "伎", "僅", "傲", "侶"],
