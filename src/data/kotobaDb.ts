...
const L_STORAGE_KEY_SETTINGS = "kotoba_n3_settings";

export interface KotobaSettings {
  practiceSentenceSize: "text-xs" | "text-sm" | "text-base" | "text-lg";
  catalogFontSize: "text-[10px]" | "text-xs" | "text-sm" | "text-base";
  translationColor: string;
  blurTranslation: boolean;
}

export const DEFAULT_SETTINGS: KotobaSettings = {
  practiceSentenceSize: "text-sm",
  catalogFontSize: "text-[10px]",
  translationColor: "text-white/70",
