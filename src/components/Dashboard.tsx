            ...
            return (
              ...
              >
                <div>
                  ...
                  {/* Translation */}
                  <p className={`${settings.catalogFontSize} ${settings.translationColor} ${settings.blurTranslation ? "blur-sm hover:blur-none transition-all cursor-help" : ""} font-bold leading-relaxed`}>
                    {item.arti}
                  </p>
                  ...
                  <div className="mt-4 pt-3 border-t border-white/5 space-y-2" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="bg-white/[0.01] rounded-lg p-2 border border-white/5">
                      <p className={`text-[11px] ${settings.translationColor} ${settings.blurTranslation ? "blur-sm hover:blur-none transition-all cursor-help" : ""} italic leading-relaxed font-serif select-text`}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-3.5 max-w-[350px]">
                        <p className={`${settings.catalogFontSize} ${settings.translationColor} ${settings.blurTranslation ? "blur-sm hover:blur-none transition-all cursor-help" : ""} font-bold mb-2`}>{item.arti}</p>
                        ...
                        <div className="bg-white/[0.02] p-2 rounded-lg border border-white/5 space-y-1.5" onClick={(e) => e.stopPropagation()}>
                          ...
                          <p className={`text-[10px] ${settings.translationColor} ${settings.blurTranslation ? "blur-sm hover:blur-none transition-all cursor-help" : ""} italic font-serif leading-normal mt-0.5 select-text`}>
                            {item.artiKalimat}
                          </p>
                        </div>
                      </td>
