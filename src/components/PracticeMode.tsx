...
import { KotobaItem, ProgressMap, KotobaSettings } from "../data/kotobaDb";
  ...
  return (
    <div id="kotoba-practice-section" className="space-y-6">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        {/* Left Column: Kanban/Sidebar Quick Navigation (lg:col-span-2) */}
        <div className="lg:col-span-2 xl:col-span-2 bg-dark-panel rounded-3xl border border-white/15 p-4 flex flex-col h-[520px] shadow-lg">
          <div className="mb-3">
              ...
              <div className="bg-dark-panel rounded-3xl border border-brand-gold/20 p-5 shadow-xl relative animate-fadeIn flex flex-col justify-between select-none h-[450px]">
                ...
                <div className="py-2.5 border-b border-light-divider/5 font-sans overflow-y-auto flex-1 h-36">
                  ...
                  <div className="space-y-1.5">
                    {revealSentenceHiragana ? (
                      <p className={`${settings.practiceSentenceSize} font-sans font-extrabold text-[#DFC15D] leading-relaxed select-text tracking-wide bg-brand-gold/[0.02] p-1.5 rounded-lg border border-brand-gold/5`}>
                        {renderHighlightedText(activeItem.contohKalimatHiragana, activeItem.hiragana, "gold")}
                      </p>
                    ) : (
                      <p className={`${settings.practiceSentenceSize} font-sans font-bold text-[#E2E8F0] leading-relaxed select-text tracking-normal`}>
                        {renderHighlightedText(activeItem.contohKalimat, activeItem.kanji, "gold")}
                      </p>
                    )}
                    
                    <div className="pt-1">
                      <span className="text-[10px] font-semibold text-[#DFC15D]/60 block font-mono">Arti Kalimat:</span>
                      <p className={`${settings.practiceSentenceSize} ${settings.translationColor} ${settings.blurTranslation ? "blur-sm hover:blur-none transition-all cursor-help" : ""} italic leading-snug font-serif select-text mt-0.5`}>
        ...
        {/* Right Column: Canvas Drawing calligraphy Workspace (lg:col-span-6) */}
